...
----
[program:frps]
directory = /root/opt/frp/
command = /root/opt/frp/frps -c /root/opt/frp/frps.yml
autostart = true
startsecs = 10
autorestart = true
startretries = 100000
...
ExecStart = /root/opt/frp/frpc -c /root/opt/frp/frpc.yml
...
[program:frpc]
directory = /root/
command = /root/opt/frp/frpc -c /root/opt/frp/frpc.yml
autostart = true
startsecs = 10
autorestart = true
startretries = 100000
